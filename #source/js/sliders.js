...
if ($(".mainslider").length > 0) {
  $(".mainslider").slick({
    ...
    autoplaySpeed: 3000,
    //asNavFor:'',
    //appendDots: 'mainslider-dots',
    //appendArrows: 'mainslider-arrows',
    nextArrow:
      '<button class="slick-next"><img src="img/arrow-right.svg"></button>',
    prevArrow:
      '<button class="slick-prev"><img src="img/arrow-left.svg"></button>',
    responsive: [
      {
        breakpoint: 768,
        settings: {}
...
if ($(".newsmodule-slider").length > 0) {
  ...
  $(".newsmodule-navigator-info span")
    .eq(1)
    .html($(".newsmodule-items-item").length);

  $(".newsmodule-slider").on("beforeChange", function(
    event,
    slick,
    currentSlide,
    nextSlide
  ...
  $(".newsmodule-slider").on("afterChange", function(
    event,
    slick,
    currentSlide
  ) {
